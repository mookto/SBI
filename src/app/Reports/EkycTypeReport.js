...
class EkycTypeReport extends Component {
  constructor() {
    super();
    this.state = {
      formDate: new Date(),
    ...
    const data = [
      {
        ...
        branch: "Gulshan",
        ekyc_status: <span className="badge badge-success">Successful</span>,
        ekyc_type: "Regular",
      ...
      },
      {
        ...
        branch: "Chittagong",
        ekyc_status: <span className="badge badge-danger">Failed</span>,
        ekyc_type: "Regular",
        onboarding_type: "Self",
        view: <Link>View</Link>,
      },
    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> eKYC Type Report</h3>
          ...
          <div className="col-12">
            <div className="col-md-3 d-inline-block">
              <div className="form-group">
                <label htmlFor="identityType">eKYC Type</label>
                ...
                >
                  <option value="All">All eKYC Type</option>
                  <option value="All">Regular</option>
                  <option value="All">Simplified</option>
                </select>
              </div>
            </div>
            <div className="col-md-3  d-inline-block">
