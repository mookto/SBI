    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> Product Wise Report</h3>
          ...
          <div className="col-12">
            <div className="col-md-3 d-inline-block">
              <div className="form-group">
                <label htmlFor="identityType">Product</label>
                ...
                >
                  ...
                  <option value="All">Saving</option>
                  <option value="Successful">FDR</option>
                  <option value="Failled">DPS</option>
                </select>
              </div>
            </div>
            <div className="col-md-3  d-inline-block">
