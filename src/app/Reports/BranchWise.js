          ...
          <div className="col-12">
            <div className="col-md-3 d-inline-block">
              <div className="form-group">
                <label htmlFor="identityType">Branch List</label>
                ...
                >
                  ...
                  <option value="All">Chittagong</option>
                  <option value="All">Gulshan</option>
                  <option value="Successful">Khulna</option>
                  <option value="Failled">Motijhil</option>
                </select>
              </div>
            </div>
            <div className="col-md-3  d-inline-block">
