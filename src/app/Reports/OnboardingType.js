    ...
    return (
      <div>
        <div className="page-header">
          <h3 className="page-title"> Onboarding Type Report</h3>
          ...
          <div className="col-12">
            <div className="col-md-3 d-inline-block">
              <div className="form-group">
                <label htmlFor="identityType">Onboarding Type</label>
                ...
                >
                  ...
                  <option value="All">Assisted</option>
                </select>
              </div>
            </div>
            <div className="col-md-3  d-inline-block">
