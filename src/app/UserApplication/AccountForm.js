  ...
  render() {
    ...
    const Page4 = (
      <>
        ...
        <Text style={[styles.textL, {}]}>
          খ) এখানে থ্রাহক হচ্ছে “সাহিব আল-মাল” (অর্থের মালিক) এবং ব্যাংক হচ্ছে
          “মুদারিব” কোরবার সংগঠক)।
        </Text>
        <Text style={[styles.textL, {}]}>
        ...
        <Text style={[styles.textL, {}]}>
          ...
          নির্ধারিত ৯/০1810192 অনুসারে “সাহিব আল-মাল” এর মধ্যে বন্টন করে।
          বিনিয়োগে লোকসান হলে “সাহিব আল-মাল” জমার আনুপাতিক হারে তা বহন করবে।
        </Text>
        <Text style={[styles.textL, {}]}>
          ড) ব্যাংক নিল্লের ৮, ৯, ১০ ও ১২ নম্বরে বর্ণিত নিয়মে জমাকৃত অর্থ ও
          মুনাফা ফেরত প্রদান করবে।
        </Text>
        <Text style={[styles.textL, {}]}>
          চ) এছাড়া ইসলামী শরীয়াহ্‌ বর্ণিত মুদারাবাহ চুক্তির অন্যান্য শতারবলি
          প্রযোজ্য হবে।
        </Text>
        <Text style={[styles.textL, { paddingLeft: "35px", fontSize: "8" }]}>
        ...
        <Text style={[styles.textL, {}]}>
          ক) এটি হিসাবধারী থ্রাহক এবং গ্লোবাল ইসলামী ব্যাংক লিমিটেডের মধ্যে
          সম্পাদিত ইসলামী শরীয়াহ্‌ ভিত্তিক একটি আল-ওয়াদীয়াহ্‌ চুক্তি।
        </Text>
        <Text style={[styles.textL, {}]}>
          খ) থাহক তার হিসাবে অর্থ জমা করবে। ব্যাংক জমাকৃত অর্থের নিরাপদ হেফাজত
        ...
        <Text style={[styles.textM, {}]}>
          ০১। সর্বনিয় ৫০০/- টাকা বা তার অধিক অংকের অর্থ জমা করে মুদারাবাহ্‌
        ...
        <Text style={[styles.textM, {}]}>
          ...
          সাত দিন পূর্বে নোটিশ দিতে হয়। নোটিশ দিয়ে অর্থ উঠালে জমাস্তিতির লাভের
          জন্য বিবেচিত হয়, অন্যথায় সে নিয়তম স্থিতির উপর লাভ প্রদান করা হবে।
        </Text>
        <Text style={[styles.textM, {}]}>
        ...
        <Text style={[styles.textM, {}]}>
          ১১। গ্রাহক অব্যবহৃত চেক বই ও /ণু'$[ কার্ড ফেরত দিয়ে যথাযথভাবে আবেদন
          করে ব্যাক নির্ধারিত ফি প্রদানপূর্বক হিসাব বন্ধ করতে পারবেন।
        </Text>
        <Text style={[styles.textM, {}]}>
        ...
        <Text style={[styles.textM, {}]}>
          ১৩। খাহকের ঠিকানায় কোন পরিবর্তন হলে অবিলম্বে তা ব্যাংককে জানাতে হবে।
          ব্যাংক সাধারণত ডাকযোগে/কুরিয়ার সার্ভিসের মাধ্যমে হিসাব মালিকের সাথে
          যোগাযোগ রক্ষা করে থাকে। প্রেরিত কোন চিঠিপত্র যথাসময়ে বা আদৌ বিলি না
          হলে ব্যাংক দায়ী থাকবে না।
        </Text>
        <Text style={[styles.textM, {}]}>
          ১৪। এ ধরনের হিসাব সরকারি নিয়মানুযায়ী কর/শুন্ক (সময়ে সময়ে
          পরিবর্তনশীল) কর্তন করা হয়।
        </Text>
        <Text style={[styles.textM, {}]}>
          ১৫। ব্যাংক কোম্পানি আইনানুযায়ী ১০ (দশ) বছর ও তদূরধ্ব মেয়াদ পর্যন্ত
        ...
        <Text style={[styles.textM, {}]}>
          ...
          উত্তরাধিকার সনদের মাধ্যমে উক্ত হিসাবে গচ্ছিত টাকা জীবিত ব্যক্তি মৃত
          ব্যক্তির উত্তরাধিকারের সাথে যৌথভাবে আবেদন করা সাপেক্ষে উক্ত হিসাবের
          অর্থ উত্তোলন করতে পারবেন।
        </Text>
        <Text style={[styles.textM, {}]}>
          ১৮। যৌথ হিসাব ধারক(গণ) কর্তৃক তীর/তাদের মৃত্যুর পর জমাকৃত অর্থ
          প্রদানের জন্য নমিনী মনোনীত করতে পারবেন হিসাবধারী হক হিসাব-ধারকের
        ...
        <Text style={[styles.textM, { paddingLeft: "50px" }]}>
          ঘ) নমিনী/নমিনীগণ কর্তৃক ইনডেমনিটি ব প্রদান। এক্ষেত্রে নমিনী কর্তৃক
        ...
        <Text style={[styles.textM, {}]}>
          ...
          সার্কুলার/নীতিমালা অনুযায়ী খাহক ব্যাংকের চাহিদা মোতাবেক যে কোন তথ্য
          সরবরাহ করতে বাধ্য থাকবেন।
        </Text>
        <Text style={[styles.textM, {}]}>
          ২০। ব্যাংক যৌক্তিক কারনে হিসাব সংক্রান্ত যে কোন নিয়মাবলি পরিবর্তন,
          পরিবর্ধন, সংশোধন বা বাতিল করতে পারে এবং খ্াহক তা মেনে চলতে বাধ্য
          থাকবেন। উপরোক্ত শর্তসমূহ ও নিয়মাবলীর আওতায় ব্যাংক এবং গ্রাহকের মধ্যে
          অন্র চুক্তিনামা সম্পাদিত হলো।
        </Text>
        <View
