    ...
    const Page4 = (
      <>
        ...
        <Text style={[styles.textM, {}]}>
          ...
          সাত দিন পূর্বে নোটিশ দিতে হয়। নোটিশ দিয়ে অর্থ উঠালে জমা,স্থিতির
          লাভের জন্য বিবেচিত হয়, অন্যথায় সে নিয়ম স্থিতির উপর লাভ প্রদান করা
          হবে।
        </Text>
        <Text style={[styles.textM, {}]}>
        ...
        <Text style={[styles.textM, { paddingLeft: "50px" }]}>
          ঘ) নমিনী/নমিনীগণ কর্তৃক ইনডেমনিটি প্রদান। এক্ষেত্রে নমিনী কর্তৃক কোর্ট
          প্রদত্ত সাকসেশন সার্টিফিকেট দাখিল করার প্রয়োজন নেই।
        </Text>
        <Text style={[styles.textM, {}]}>
